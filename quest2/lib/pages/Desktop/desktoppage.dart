      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Container(
              padding:
                  const EdgeInsets.symmetric(horizontal: 135, vertical: 80),
              constraints: BoxConstraints(
            ...
            Container(
              padding:
                  const EdgeInsets.symmetric(horizontal: 135, vertical: 120),
              child: Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                      ...
                      children: [
                        ...
                        const Text.rich(
                          TextSpan(
                            ...
                            children: [
                              TextSpan(
                                  text: '퀘스트스쿨은 진로 콘텐츠 전문 기업 사자가온다(주)에서\n'),
                              TextSpan(text: '개발한 교내 진로진학 상담 솔루션 서비스입니다.'),
                            ],
                          ),
                        ),
                        const SizedBox(
